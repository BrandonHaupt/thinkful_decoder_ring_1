...
const substitutionModule = (function () {
  ...
  function substitution(input, alphabet="", encode = true) {
    ...
    splitMessage = message.split(""); //trueShift
    
    // console.log(alphabetSplit, message)
    ...
    if (encode) {
      ...
      for (let a = 0; a < message.length; a++) {
        // console.log("trueshift", message[a])
    ...
    // console.log(message)
    //  console.log(`hmm`, encoded, realMessage, encoded)
    return realMessage
  }
